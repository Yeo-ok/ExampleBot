...
public class Mute implements Command{
    ...
    public List<OptionData> getOptions() {
        ...
        optionData.add(new OptionData(OptionType.USER, "음소거", "이 유저는 음소거 됩니다.", true));
        return optionData;
    }
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        if(member.getRoles().contains(role)){
            ...
            guild.removeRoleFromMember(muteMember, defaultRole).queue();
            guild.addRoleToMember(muteMember, muteRole).queue();
        } else {
